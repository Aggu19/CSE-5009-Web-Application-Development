...
<nav id="desktop-nav">
    <div class="Logo">
        <!-- <img src="asset/logo.png" alt="Gallery Café Logo" /> -->
    </div>
    <div>
        <ul class="nav-links">
         ...
         <div class="menu-section">
            ...
            <div class="dish-container">
                <div class="signature-dish-card">
                    <img src="asset/sushii.jpg" alt="Signature Dish" class="dish-image">
                    <div class="dish-info">
                ...
                <div class="signature-dish-card">
                    <img src="asset/grilled.jpg" alt="Signature Dish" class="dish-image">
                    <div class="dish-info">
                ...
                <div class="signature-dish-card">
                    <img src="asset/tacos.jpg" alt="Signature Dish" class="dish-image">
                    <div class="dish-info">
    ...
    <section id="contact">
        <div class="contact-section">
            ...
            <div class="b">
                ...
                <a href="common.php" class="signup-link">Sign Up Now</a>
    ...
    <footer>
        ...
        <p>Copyright &#169; 2024 Arkam. All Rights Reserved.</p>
    </footer>    
