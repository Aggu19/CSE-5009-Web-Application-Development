...
$stmt_order->execute();
$pending_orders = $stmt_order->fetchAll(PDO::FETCH_ASSOC); // Use fetchAll() to get the results
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Staff - Confirmed Orders</title>
</head>
<body>
    ...
    <section class="home-section">
        ...
        <div class="next">
            ...
            <div class="pending_orders">
                <!-- Display confirmed orders in customer page -->
                <?php if (count($pending_orders) > 0): ?> <!-- Check if there are confirmed orders -->
                    <div class="cards">
